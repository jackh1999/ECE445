...
void app_main(void)
{
    ...
    char first_message[13] =  "API Something";
    ESP_LOGI("Serial", "This can work");
    ...
    ESP_ERROR_CHECK(spi_device_polling_transmit(adc_handle, &t));
    ESP_ERROR_CHECK(gpio_set_level(ADC_CS, 0));
    ESP_LOGI("Done polling", "");

    int byte_0 = t.rx_data[0];
    int byte_1 = t.rx_data[1];
    int byte_2 = t.rx_data[2];
    int byte_3 = t.rx_data[3];

    char second_message[15] = {byte_0 / 100 + 48, byte_0 / 10 % 10 + 48, byte_0 % 10 + 48, ' ', byte_1 / 100 + 48, byte_1 / 10 % 10 + 48, byte_1 % 10 + 48, ' ', \
                               byte_2 / 100 + 48, byte_2 / 10 % 10 + 48, byte_2 % 10 + 48, ' ', byte_3 / 100 + 48, byte_3 / 10 % 10 + 48, byte_3 % 10 + 48};


    display_message(second_message, 15);
    update_menu(panel_handle);
